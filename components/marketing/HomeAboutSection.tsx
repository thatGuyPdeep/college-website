    ...
    <section className="home-section bg-white">
      <div className="container-site">
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col">
            ...
            <div className="flex flex-wrap gap-4 mt-5">
              <Link
                ...
                className="inline-flex items-center gap-1 px-5 py-2 bg-[#B80F0A] hover:bg-[#9B1812] text-white text-xs font-bold uppercase tracking-wide transition-colors"
              >
                Read More <ArrowRight className="h-3.5 w-3.5" />
              </Link>
              <Link
                href={HOME_ABOUT.newsletterHref}
                className="inline-flex items-center gap-1 text-sm font-semibold text-[#003366] hover:underline"
              >
                News feed (RSS)
              </Link>
            </div>
          ...
          {/* Campus image / video placeholder */}
          <div className="lg:col-span-4 relative aspect-[4/3] lg:aspect-auto lg:min-h-[280px] overflow-hidden group">
            <Image
            ...
            />
            <div className="absolute inset-0 bg-[#0D2660]/20 group-hover:bg-[#0D2660]/10 transition-colors" />
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="flex items-center justify-center w-14 h-14 rounded-full bg-[#B80F0A]/90 text-white shadow-lg">
          ...
          {/* Secretary's Corner */}
          <div className="lg:col-span-4 bg-[#2b2d3b] text-white flex flex-col">
            <div className="relative aspect-[16/10] lg:aspect-auto lg:h-36 shrink-0">
              <Image
                src={leader.image}
                alt={leader.name}
                fill
            ...
            <div className="p-5 sm:p-6 flex flex-col flex-1">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1 mt-4 text-xs font-bold uppercase tracking-wide text-[#F5C200] hover:text-white transition-colors"
              >
                Read More <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
