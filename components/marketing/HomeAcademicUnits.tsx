          ...
          {HOME_ACADEMIC_UNITS.map((unit, i) => {
            ...
            return (
              <Link
                key={unit.href}
                href={unit.href}
                className="iitd-unit-box group flex flex-col items-center text-center bg-white p-5 sm:p-6 border border-gray-200 hover:border-[#B80F0A] micro-press"
              >
                <div className="iitd-unit-icon flex items-center justify-center w-16 h-16 rounded-full border-2 border-[#0D2660] text-[#0D2660] group-hover:bg-[#B80F0A] group-hover:border-[#B80F0A] group-hover:text-white mb-3">
