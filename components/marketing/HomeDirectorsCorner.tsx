...
/** IIT Delhi — single “Director’s Corner” leadership card */
export function HomeDirectorsCorner() {
  const leader = LEADERSHIP_PROFILES[0];

  return (
    <section className="home-section bg-[#f5f5f5] border-y border-gray-200">
      <div className="container-site">
        <h2 className="text-xl sm:text-2xl font-bold text-[#0D2660] mb-5 sm:mb-6">Secretary&apos;s Corner</h2>
        <article className="grid md:grid-cols-5 gap-6 bg-white border border-gray-200 rounded-lg overflow-hidden">
