...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    "", "/about", "/about/history", "/about/milestones", "/about/organization", "/about/awards", "/about/activities", "/about/governance", "/policies", "/donate", "/vision-mission",
    "/academics", "/academics/iti", "/academics/departments", "/academics/calendar", "/academics/syllabus", "/nep-2020",
    "/faculty", "/campus/infrastructure", "/campus/sports", "/campus/library", "/campus/library/e-resources", "/campus/hostel",
    ...
    "/research", "/research/facilities", "/people", "/people/faculty", "/people/staff", "/people/students", "/people/authorities",
    "/administration", "/prospectus", "/timetable", "/noticeboard",
    "/academics/faculties", "/academics/faculties/science", "/academics/faculties/social-science", "/academics/faculties/sports",
    "/careers/opportunities", "/faculty-portal", "/faculty-portal/attendance", "/faculty-portal/salary-slips", "/faculty-portal/leave", "/faculty-portal/payroll",
