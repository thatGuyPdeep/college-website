...
export const NAV_LINKS = [
  ...
  { label: "Research", href: "/research", children: [
    ...
    { label: "Research Promotion Cell", href: "/cells/research-promotion" },
    { label: "Library Publications", href: "/campus/library/publications" },
    { label: "E-Resources",          href: "/campus/library/e-resources" },
  ]},
  { label: "People", href: "/people", children: [
    { label: "People Home",         href: "/people" },
    { label: "Faculty",             href: "/people/faculty" },
    { label: "Staff",               href: "/people/staff" },
    { label: "Students",            href: "/people/students" },
    { label: "Authorities",         href: "/people/authorities" },
    { label: "Alumni",              href: "/alumni" },
    { label: "Career Opportunities", href: "/careers/opportunities" },
  ]},
  { label: "Administration", href: "/administration", children: [
    { label: "Administration Home", href: "/administration" },
    { label: "Leadership",          href: "/about/leadership/secretary" },
  ...
  { label: "Students", href: "/students-corner", children: [
    ...
    { label: "Faculty ERP Login", href: "/login?redirect=/faculty-portal" },
    { label: "Study Material",    href: "/study-material" },
    { label: "NSS",               href: "/nss" },
...
export const REQUIRED_DOCUMENTS = [
  ...
  { type: "domicile",          label: "Domicile Certificate"        },
  { type: "transfer_cert",     label: "Transfer Certificate (TC)"   },
  { type: "migration_cert",    label: "Migration Certificate"       },
];
...
export const EXTERNAL_LINKS = {
  ...
  /** Affiliated university — online admission portal */
  smkvUniversity: "https://smkvbastar.ac.in",
};
