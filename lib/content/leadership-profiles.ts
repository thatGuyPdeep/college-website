...
export const LEADERSHIP_PROFILES: LeadershipProfile[] = [
  ...
  },
  {
    ...
    title: "Principal",
    titleHi: "प्राचार्य",
    org: "Ramakrishna Mission College, Narayanpur",
    image: "/images/school-1.jpg",
    body: "Academic head of undergraduate (FYUGP) programmes affiliated to Bastar University under NEP 2020. Oversees faculty, examination coordination, and student welfare at the college.",
    message:
      "Our college combines rigorous academics with value-based education. Students are encouraged to develop character, competence, and compassion — qualities essential for serving society, especially the tribal communities of Bastar.",
  },
  {
